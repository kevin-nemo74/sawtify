...
class _BottomNavigationBarWidgetState extends State<BottomNavigationBarWidget> {
  ...
  padding: const EdgeInsets.fromLTRB(16, 0, 16, 16), // Add margin bottom
  child: ClipRRect(
    borderRadius: BorderRadius.circular(60.0), // Adjust this value as needed
    child: Container(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 12.0, vertical: 12.0), // Decreased padding
        child: GNav(
          gap: 8,
          ...
          tabBackgroundColor: Color.fromARGB(255, 249, 249, 249).withOpacity(0.1),
          padding: EdgeInsets.symmetric(horizontal: 16, vertical: 10), // Decreased padding
